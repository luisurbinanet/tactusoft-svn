...
INSERT INTO `med_question` VALUES (1,'Hace menos de una semana que ha tenido un hijo',1,'ASSERTIVE',NULL,NULL,NULL,NULL,NULL,0,2,3,1),(2,'La DEPRESIÓN AL TERCER DÍA es el nombre mas común para este sentimiento de tristeza y depresión que afecta a muchas mujeres en los 7 días siguientes al parto',1,'FINAL','IMAGE',NULL,'question2.jpeg',NULL,NULL,1,-1,-1,2),(3,'Se siente bien la mayor parte del tiempo pero a veces se siente deprimida e irritable',1,'ASSERTIVE',NULL,'http://es.wikipedia.org/wiki/Depresi%C3%B3n_postparto',NULL,NULL,NULL,1,4,5,3),(4,'Los periodos de DEPRESIÓN e IRRITABILIDAD son comunes en los meses siguientes al nacimiento del niño. Al mismo tiempo que se ve afectada por los cambios hormonales y posibles sentimientos contradictorios, también es posible que se encuentre cansada y preocupada por su responsabilidad maternal o por el desarrollo general del niño',1,'FINAL','VIDEO','http://es.wikipedia.org/wiki/Depresi%C3%B3n_postparto',NULL,NULL,'',2,-1,-1,4),(5,'La DEPRESIÓN POSTPARTO es un problema que afecta madres primerizas en los primeros 6 meses después del parto',1,'FINAL','LINK','http://es.wikipedia.org/wiki/Depresi%C3%B3n_postparto',NULL,NULL,'',2,-1,-1,5),(6,'pregunta 6',1,'ASSERTIVE',NULL,NULL,NULL,NULL,NULL,1,7,8,6),(7,'PREGUNTA 7',1,'ASSERTIVE',NULL,NULL,NULL,NULL,NULL,1,-1,-1,7),(8,'PREGUNTA 8',1,'ASSERTIVE',NULL,NULL,NULL,NULL,NULL,1,-1,-1,6);
...
-- Dump completed on 2012-03-06 17:54:44
