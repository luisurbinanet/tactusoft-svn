...
public class ExpiredExceptionHandler extends ExceptionHandlerWrapper {

	private ExceptionHandler wrapped;

	public ExpiredExceptionHandler(ExceptionHandler wrapped) {
			...
			if (eqec.getException() instanceof ViewExpiredException) {
				...
				try {
					navHandler.handleNavigation(context, null,
							"/pages/public/login?faces-redirect=true&expired=true");
				} finally {
					it.remove();
				}
			}
