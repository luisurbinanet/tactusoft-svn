...
INSERT INTO `kpi_user` VALUES (1,'carlossarmientor@gmail.com','123','CARLOS','ARTURO','SARMIENTO',NULL,1),(2,'barrientose@gmail.com','123','EDUARDO',NULL,'BARRIENTOS',NULL,1);
...
INSERT INTO `kpi_daily` VALUES (8,'2012-02-12 00:00:00',NULL,7,4,3,2,1),(9,'2012-02-13 00:00:00',NULL,10,7,5,2,1),(10,'2012-02-14 00:00:00',NULL,9,4,3,2,1),(11,'2012-02-15 00:00:00',NULL,10,8,7,2,1),(12,'2012-02-16 00:00:00',NULL,10,6,3,2,1),(13,'2012-02-17 00:00:00',NULL,10,9,6,2,1),(14,'2012-02-18 00:00:00',NULL,8,6,2,2,1),(15,'2012-02-01 00:00:00',NULL,5,3,2,1,1),(16,'2012-02-02 00:00:00',NULL,6,0,0,1,1),(17,'2012-02-03 00:00:00',NULL,8,0,0,1,1),(18,'2012-02-04 00:00:00',NULL,8,0,0,1,1),(19,'2012-02-05 00:00:00',NULL,9,0,0,1,1),(20,'2012-02-06 00:00:00',NULL,6,0,0,1,1),(21,'2012-02-07 00:00:00',NULL,8,0,0,1,1);
...
INSERT INTO `kpi_user_role` VALUES (1,1,1);
...
INSERT INTO `kpi_week` VALUES (1,'SC20121','SEMANA 6 DE TRABAJO','2012-02-01 00:00:00','2012-02-07 00:00:00',7,40),(2,'SC20122','SEMANA 7 DE TRABAJO','2012-02-12 00:00:00','2012-02-18 00:00:00',10,40),(3,'SC20123',NULL,'2012-02-18 00:00:00','2012-02-24 00:00:00',20,40);
...
INSERT INTO `kpi_company` VALUES (-1,NULL,'KPI',NULL,'KPI','carlossarmientor@gmail.com',1),(1,NULL,'EMPRESA 1','123','PERSONA 1','correo@empresa1.com',1),(2,NULL,'EMPRESA 2','888','PERSONA 2','correo@empresa2.com',1),(3,NULL,'EMPRESA 3',NULL,'PERSONA 3','correo@empresa3.com',1),(4,NULL,'EMPRESA 4','12348','PERSONA 4','correo@empresa4.com',1);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `kpi_daily_sum_hours` AS select `a`.`id_daily` AS `id_daily`,`b`.`ID` AS `id_delay`,`b`.`NAME` AS `name_daily`,sum(`a`.`num_hours`) AS `num_hours` from (`kpi_daily_delay` `a` join `kpi_delay` `b`) where ((`b`.`ID` = `a`.`id_delay`) and (`a`.`num_hours` > 0) and (`a`.`id_daily` = 14)) group by `b`.`ID`,`b`.`NAME` order by sum(`a`.`num_hours`) desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2012-02-27 14:33:33
