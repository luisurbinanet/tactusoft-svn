...
/**
 * CrmSapMedicationId generated by hbm2java
 */
@Embeddable
public class CrmSapMedicationId implements java.io.Serializable {
	
	private static final long serialVersionUID = 1L;
	private String idBill;
	private String posBill;

	public CrmSapMedicationId() {
	}

	public CrmSapMedicationId(String idBill, String posBill) {
		this.idBill = idBill;
