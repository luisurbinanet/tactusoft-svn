...
CREATE DATABASE  IF NOT EXISTS `medical-video_db` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_spanish_ci */;
USE `medical-video_db`;
-- MySQL dump 10.13  Distrib 5.5.16, for Win32 (x86)
--
-- Host: localhost    Database: medical-video_db
-- ------------------------------------------------------
-- Server version	5.5.20
...
CREATE TABLE `med_body_detail` (
  ...
  `url` varchar(4000) COLLATE latin1_spanish_ci NOT NULL,
...
INSERT INTO `med_parameter` VALUES (1,'URL_IMAGES','http://localhost:8080/images/',NULL),(2,'DIRECTORY_IMAGES','C:\\affinity\\medical-video\\',NULL);
