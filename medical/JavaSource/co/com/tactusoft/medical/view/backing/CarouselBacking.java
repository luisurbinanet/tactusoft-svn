...
public class CarouselBacking implements Serializable {
	...
	public String generateQuestions() {
		/*
		 * QuestionBacking questionBacking =
		 * FaceUtils.findBean("questionBacking"); switch (selectedMenu.getId())
		 * { case 1: List<Question> list = new ArrayList<Question>();
		 * 
		 * Question question = new Question(); question.setId(1);
		 * question.setName("Hace menos de una semana que ha tenido un hijo");
		 * question.setPositive(2); question.setNegative(3); list.add(question);
		 * 
		 * question = new Question(); question.setId(2); question.setName(
		 * "La DEPRESIÓN AL TERCER DÍA es el nombre mas común para este sentimiento de tristeza y depresión"
		 ...
		 * ); list.add(question);
		 * 
		 * question = new Question(); question.setId(3); question.setName(
		 * "Se siente bien la mayor parte del tiempo pero a veces se siente deprimida e irritable"
		 * ); question.setPositive(4); question.setNegative(5);
		 * list.add(question);
		 * 
		 * question = new Question(); question.setId(4); question.setName(
		 * "Los periodos de DEPRESION e IRRITABILIDAD son comunes en los meses siguientes al nacimiento del niño. "
		 * +
		 ...
		 * ); list.add(question);
		 * 
		 * question = new Question(); question.setId(5); question.setName(
		 * "La DEPRESIÓN POSTPARTO es un problema que afecta madres primerizas en los primeros 6 meses después del parto"
		 * ); question.setFinalQuestion(1);
		 * question.setUrl("http://es.wikipedia.org/wiki/Depresi%C3%B3n_postparto"
		 * ); list.add(question);
		 * 
		 ...
		 * 
		 * break; case 2: case 3: case 4: case 5: Question selectedQuestion =
		 * new Question(); selectedQuestion.setId(-1); selectedQuestion
		 * .setName("No existe información. Contacte al Administrador");
		 * selectedQuestion.setFinalQuestion(1);
		 * 
		 * questionBacking.setSelectedQuestion(selectedQuestion); break;
		 * 
		 * }
		 */
		return "GO_QUESTION";
