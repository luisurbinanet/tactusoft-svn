...
CREATE TABLE `med_answer` (
  ...
  CONSTRAINT `fk_med_answer_1` FOREIGN KEY (`id_question`) REFERENCES `med_question` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `med_answer` VALUES (1,'Opcion 1',22,5),(2,'Opción 2',22,4);
...
INSERT INTO `med_question` VALUES (1,'Hace menos de una semana que ha tenido un hijo',1,'ASSERTIVE',NULL,NULL,NULL,NULL,'',2,3,1),(2,'La DEPRESIÓN AL TERCER DÍA es el nombre mas común para este sentimiento de tristeza y depresión que afecta a muchas mujeres en los 7 días siguientes al parto',1,'FINAL','IMAGE',NULL,'question2.jpeg',NULL,'',-1,-1,2),(3,'Se siente bien la mayor parte del tiempo pero a veces se siente deprimida e irritable',1,'ASSERTIVE',NULL,'',NULL,NULL,'',4,22,3),(4,'Los periodos de DEPRESIÓN e IRRITABILIDAD son comunes en los meses siguientes al nacimiento del niño. Al mismo tiempo que se ve afectada por los cambios hormonales y posibles sentimientos contradictorios, también es posible que se encuentre cansada y preocupada por su responsabilidad maternal o por el desarrollo general del niño',1,'FINAL','VIDEO','http://www.youtube.com/v/f5_ZFg0mIvI',NULL,'flash','ON_LINE',-1,-1,4),(5,'La DEPRESIÓN POSTPARTO es un problema que afecta madres primerizas en los primeros 6 meses después del parto',1,'FINAL','LINK','http://es.wikipedia.org/wiki/Depresi%C3%B3n_postparto',NULL,NULL,'',-1,-1,5),(9,'Siente dolor o malestar al orinar',3,'ASSERTIVE',NULL,NULL,NULL,NULL,'',11,10,1),(10,'Cuando va a orinar lo hace en grandes cantidades y de color palido',3,'ASSERTIVE',NULL,NULL,NULL,NULL,'',12,13,2),(11,'Ver Tabla',3,'FINAL','LINK','',NULL,NULL,'',-1,-1,3),(12,'Tiene mucho frío y se siente tensa',3,'ASSERTIVE',NULL,NULL,NULL,NULL,'',20,-1,4),(13,'Has notado algunos de los siguientes síntomas: Aumento de la sed, perdida de peso, cansancio, prurito genital',3,'ASSERTIVE',NULL,NULL,NULL,NULL,'',14,15,5),(14,'La Diabetes MELLITUS es una posibilidad, este problema es provocado por una producción insuficiente de insulina (hormona que ayuda a convertir el azucar)',3,'FINAL','IMAGE',NULL,'question14.jpeg',NULL,'',-1,-1,6),(15,'Ha Bebido más cafe de lo habitual',3,'ASSERTIVE',NULL,NULL,NULL,NULL,'',16,17,7),(16,'El Alcohol y la Cafeína puede alimentar la producción de Orina',3,'FINAL','IMAGE',NULL,'question16.jpeg',NULL,'',-1,-1,8),(17,'Está siguiendo algún tratamiento con fármacos',3,'ASSERTIVE',NULL,NULL,NULL,NULL,'',18,12,9),(18,'Ciertos Fármacos, sobre todo los que se utilizan para prevenir la retención de líquidos, provoca el aumento de la producción de orina.\r\n\r\nCONSULTE A SU MEDICO!',3,'FINAL','LINK','http://affinitycolombia.com/web_affinity/',NULL,NULL,'',-1,-1,10),(19,'Consulte a su médico sino puede hacer un diagnostico a partir de esta tabla',3,'FINAL','IMAGE',NULL,'question19.png',NULL,'',-1,-1,11),(20,'El frío o la excitación puede provocar un aumento en la frecuencia en la micción, pero esto no es motivo de preocupación.',3,'FINAL','IMAGE',NULL,'question20.png',NULL,'',9,11,12),(21,'qqqqq',3,'ASSERTIVE','IMAGE',NULL,NULL,NULL,NULL,9,10,13),(22,'Escoja una Respuesta',1,'UNIQUE','IMAGE',NULL,NULL,NULL,NULL,-1,-1,6),(23,'Prueba',1,'FINAL','IMAGE',NULL,'question23.png',NULL,NULL,-1,-1,7),(24,'Prueba 1',5,'FINAL','VIDEO','http://localhost:8080/images/Wildlife.wmv',NULL,'windows','ON_LINE',-1,-1,1);
...
-- Dump completed on 2012-03-14  6:09:45
